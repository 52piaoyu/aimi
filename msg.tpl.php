...
<script>
	window.onload = function(){
		...
		let hd = document.getElementsByTagName('header')[0].clientHeight;
		let ft = document.getElementsByTagName('footer')[0].clientHeight;
		let b = window.screen.height;
		console.log(b);
		console.log(hd);
		console.log(ft);
		id.style.height = b-200-(hd+ft+50)+'px';
	}
</script>
